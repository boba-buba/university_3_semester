<?php
	...
	if (strtoupper($_SERVER['REQUEST_METHOD']) == 'POST' && isset($_POST['images'])) {
		...
		// The followin two lines are the only difference from 01-post example...
		header("Location: ?");	// Create HTTP 302 redirection.
		exit;					// Quit now, so the HTML is not shown this time around...
	}
?>
<!DOCTYPE HTML>
<html>
